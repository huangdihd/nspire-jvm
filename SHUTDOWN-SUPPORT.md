...
also preserved from the same pinned revision; the runtime now contains 451
...
at Map.of in LangManager initialization after entering Xinbot.main. Because this is a fatal interpreter error, its extracted
