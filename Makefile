...
SOURCES = src/main.c src/vm.c src/context.c src/ndless_compat.c src/canonical.c vendor/miniz.c vendor/expat/lib/xmlparse.c vendor/expat/lib/xmlrole.c vendor/expat/lib/xmltok.c
...
build/nspire-jvm build/ndless/src/vm.o: src/filesystem.inc src/canonical.h src/time.inc
...
build/file-lifetime: file-tests/lifetime.c $(filter-out src/main.c,$(HOST_SOURCES)) $(wildcard src/*.h src/*.inc) vendor/openjdk8-file/canonicalize_md.c vendor/openjdk8-api/methods.inc Makefile
	mkdir -p build
