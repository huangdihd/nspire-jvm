...
build/nspire-jvm build/ndless/src/vm.o: src/enums.inc src/builder.inc src/annotations.inc src/character.inc src/regex.inc src/parse_number.inc src/environment.inc src/output.inc vendor/openjdk17-casing/character.inc
